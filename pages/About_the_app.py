...
layout = dbc.Container([
    html.Div([
        ...
        html.P("La aplicación 'Dataset Inspector' ha sido desarrollada por Jesús, Samuel y Pablo como parte de un proyecto de la asignatura de 'Visualización Avanzada de Datos' del Máster en Ciencia de Datos de la Universitat de València."),
        ...
        html.Hr(),
        html.H2("Sobre los Autores"),
        html.P("Los autores de esta aplicación son:"),
        html.Ul([
            html.Li([html.A("Martínez Leal, Jesús", href="mailto:jemarle@alumni.uv.es")]),
            html.Li([html.A("Ortega Mediavilla, Samuel", href="mailto:saorme@alumni.uv.es")]),
            html.Li([html.A("Vicente Martínez, Pablo", href="mailto:pavimar6@alumni.uv.es")])
        ])
    ])
], fluid=True)
